...
def scrape_Mars():  
    ...
    wea_text=resultsWea[0].find('p',{'class':'js-tweet-text'}).text
    ...
    hemisph_dict = dict(zip(center_landmark, zip(title, img_url)))
    ...
    return mars_data = {
        ...
        "Image": image_link,
        "Weather": wea_text,
        "Mars Stats": MarsTable.html,
        "Hemispheres": hemisph_dict
    }